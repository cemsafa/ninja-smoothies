  ...
  <div class="edit-smoothie container" v-if="smoothie">
    <h2>Edit {{ smoothie.title }} Smoothie</h2>
      ...
      <div class="field edit-title">
        <label for="edit-title">Smoothie Title:</label>
        <input type="text" name="edit-title" v-model="smoothie.title">
      </div>
      ...
      <div class="field edit-ingredient">
        ...
        <input type="text" name="edit-ingredient" @keydown.tab.prevent="EditIngredient" v-model="another">
      </div>
